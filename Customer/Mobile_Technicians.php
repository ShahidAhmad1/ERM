...
while ($Technician_row = mysqli_fetch_assoc($Technician_result)) {
    ...
    if ($Customer_row['Customer_Pincode'] == $Technician_row['Technician_Pincode'] and $Technician_row['Technician_Type'] == "Mobile_Technician") {
        echo "<tr>";
...
<head>
    ...
    <title>Mobile Technicians</title>
    <link rel="stylesheet" href="../CSS/style.css">
</head>

<body>
    <a href="Mobile_Tech_other_results.php">Show other results</a><br>
