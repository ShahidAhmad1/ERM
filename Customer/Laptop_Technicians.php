...
while ($Technician_row = mysqli_fetch_assoc($Technician_result)) {
    ...
    if ($Customer_row['Customer_Pincode'] == $Technician_row['Technician_Pincode'] and $Technician_row['Technician_Type'] == "Laptop_Technician") {
        echo "<tr>";
...
<body>
    <a href="Laptop_Tech_other_results.php">Show other results</a><br>
